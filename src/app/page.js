...
// Calculate statement totals from filtered orders
const stmtFromOrders=useMemo(()=>{const matched=orders.filter(o=>o.hasStatement);if(!matched.length)return null;return{totalSales:matched.reduce((s,o)=>s+(o.saleVND||0),0),totalFees:matched.reduce((s,o)=>s+(o.feeVND||0),0),totalTax:matched.reduce((s,o)=>s+(o.taxVND||0),0),totalVAT:matched.reduce((s,o)=>s+(o.vatVND||0),0),totalAds:0}},[orders]);
const displayStmt=stmtFromOrders||activeStmt;
